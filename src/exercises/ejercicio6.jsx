...
function Temporizador(){
    ...
    return (
        ...
        <button className="p-2 border-2 border-black rounded-2xl hover:cursor-pointer">Pausar</button>
        <button className="p-2 border-2 border-black rounded-2xl hover:cursor-pointer">Reiniciar</button>
        </>
    )
}
//Modificar su estado en cada intervalo de un minuto
//Crear componente pausar
//Crear componente reiniciar
